...
const zh: Translation = {
  ...
  "testimonials": {
    "title": "目前收到的全部评价",
    "subtitle": "应用还很新，所以还不多。这里是收到的每一条评价，未经改动，由丹麦语译出。",
    "comments": [
      "要规划并推进项目时，无论大小，这个应用都很出色。真希望几年前我们翻修一套公寓的时候就有它。用来规划和记录整个翻修、花掉的工时和买过的材料，会非常有用。"
    ]
  },
  "faq": {
    "title": "常见问题解答",
  ...
  "stakes": {
    ...
    "title": "超支不会提前打招呼",
    "body": [
      "它是这里的几百块、那里的一笔变更、还有一张你打算收好的收据。每一笔都小到可以挥手放过，而其中没有任何一笔，是你真正察觉的那一刻。",
      "等表格告诉你的时候，瓷砖已经铺好，钱也已经花完。半年后保险公司问起那面墙后面原本是什么，没有人手里有照片。"
    ],
    "stat": {
      "value": "15–30%",
      "caption": "家装通常超出预算的区间——老房子更宽，凡是要开墙的工程也更宽。",
      "linkText": "看看数据怎么说"
    },
    "success": {
      "label": "另一条路",
