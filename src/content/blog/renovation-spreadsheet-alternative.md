...
faq:
  ...
  - question: "What about using Notion or Airtable for a renovation?"
    answer: "Both work, with the same on-site logging problem as a spreadsheet — they're fundamentally desk tools. Notion is excellent for the planning phase (mood boards, contractor research) and frustrating once you're on-site. Use it for planning, switch to a phone-first app for execution."
  - question: "When should I switch from a spreadsheet to a dedicated app?"
...
| Task | In a spreadsheet | In a renovation app |
|---|---|---|
...
- **Line item structure** transfers directly. The 9 standard categories (see our [budget template post](/blog/renovation-budget-template/)) are the same in any tool.
- **Contractor quotes and contact info** can sit in a "Project notes" field in the app, or stay in the original spreadsheet as a reference document.
- **Contingency calculation** carries across — set the same percentage.
- **The act of having thought through every line item once** is the real value. The tool change just keeps that work alive.
