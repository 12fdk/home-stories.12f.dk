...
description: "Four ways to track home improvement expenses — spreadsheet, Notion, a dedicated app, and receipts-in-a-jar — compared honestly on what actually works when the dust is flying."
...
The most common starting point by a wide margin. If you've read the [renovation budget template guide](/blog/renovation-budget-template/), you've already got a spreadsheet set up with nine categories and fifty line items. Now you just need to fill in the "actual paid" column.
...
**Verdict:** Notion is a brilliant renovation hub for the planning phase. For expense tracking during execution, it suffers from the same problems as a spreadsheet — the friction of logging exceeds the focus you have on-site. [More on Notion vs dedicated tools here](/blog/notion-for-home-renovation/).
